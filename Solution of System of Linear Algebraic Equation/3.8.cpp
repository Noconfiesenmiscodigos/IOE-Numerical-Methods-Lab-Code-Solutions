/*WAP to find Solution of System of Linear Algebraic Equation with Cramer’s Rule Method.*/
#include <iostream>
#include <cmath>
#include <iomanip>
#include <cstring>
...
int main()
{
    ...
    while(1)
    {
        ...
        if (d==0)
        {
            cout<<" Since |A| = 0, We can't find Solution of System of Linear Algebraic Equation with Cramer’s Rule Method."<<endl<<endl;
        }
        else
        {
            x = x/d;
