/*WAP to find Solution of System of Linear Algebraic Equation with Gauss Jordan Method.*/
#include <iostream>
#include <cmath>
#include <iomanip>
#include <cstring>
...
int main()
{
    ...
    while(1)
    {
        ...
        a[0][3]=a[0][3]-(a[0][2]*a[2][3])/a[2][2];//R1
        a[1][3]=a[1][3]-(a[1][2]*a[2][3])/a[2][2];//R2
        a[0][2]=0;
        a[1][2]=0;
        print_matrix();
        cout<<"\n\n R1 = R1 - ("<<a[0][1]<<"/"<<a[1][1]<<") * R2\n\n";
        a[0][3]=a[0][3]-(a[0][1]*a[1][3])/a[1][1];//R1
        a[0][1]=0;
        print_matrix();
        cout<<"\n\n R1 = R1/"<<a[0][0]<<"\n\n";
        cout<<"\n\n R2 = R2/"<<a[1][1]<<"\n\n";
        cout<<"\n\n R3 = R3/"<<a[2][2]<<"\n\n";
        a[0][3]=a[0][3]/a[0][0];//R1
        a[1][3]=a[1][3]/a[1][1];//R2
        a[2][3]=a[2][3]/a[2][2];//R3
        a[0][0]=1;
        a[1][1]=1;
        a[2][2]=1;
        print_matrix();
